...
#include <openvino_armor_detector/ba_solver.hpp>
// std
#include <memory>
// g2o
...
// project
#include <openvino_armor_detector/graph_optimizer.hpp>
...
BaSolver::solveBa(const ArmorObject &armor, const Eigen::Vector3d &t_camera_armor,
  ...
  double armor_pitch =
      armor.label == 6 ? -FIFTTEN_DEGREE_RAD : FIFTTEN_DEGREE_RAD;//前哨站的pitch角和一般装甲板不同
  ...
  const auto &landmarks = armor.points;
